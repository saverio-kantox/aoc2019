defmodule Day01 do
  ...
  * For a mass of 100756, the fuel required is 33583.
  ...
  Your puzzle answer was 4892166.

  Solutions:
      iex> "priv/day_01_input.txt" |> File.read!() |> Day01.one()
      3263354
      iex> "priv/day_01_input.txt" |> File.read!() |> Day01.two()
      4892166
  """
  ...
  Examples:
      ...
      iex> Day01.one("1969")
      654
      iex> Day01.one("100756")
      33583
      iex> Day01.one("12 14 1969 100756")
      2 + 2 + 654 + 33583
  """
  @spec one(binary()) :: non_neg_integer()
  def one(inputs) do
    inputs
  ...
  Examples:
      ...
      iex> Day01.two("1969")
      966
      iex> Day01.two("100756")
      50346
      iex> Day01.two("12 12 12")
      6
  """
  @spec two(binary) :: non_neg_integer
  def two(inputs) do
    inputs
    |> String.split(~r/\s+/, trim: true)
    |> Enum.map(&String.to_integer/1)
    |> Enum.map(&recursive_cost/1)
    |> Enum.reduce(0, &(&1 + &2))
  end

  @spec recursive_cost(non_neg_integer()) :: non_neg_integer()
  defp recursive_cost(weight) do
    case cost(weight) do
      0 -> 0
      n -> n + recursive_cost(n)
    end
  end

  @spec cost(non_neg_integer()) :: non_neg_integer()
  defp cost(weight), do: max(0, Integer.floor_div(weight, 3) - 2)
end
